...
module Es6ifyLike {
    ...
    export function es6ify(filePattern?: { test(str: string): boolean; } | RegExp, willProcess?: (file: string, willProcess: boolean) => void, dataDone?: (file: string, data: string) => void) {
