...
(function (TypeScriptUtil) {
     ...
     * @param callback
     */
    function compileTypeScriptFile(tscCmd, projRelativeSrcPath, callback) {
    ...
    TypeScriptUtil.compileTypeScriptFile = compileTypeScriptFile;
})(TypeScriptUtil || (TypeScriptUtil = {}));
module.exports = TypeScriptUtil;
